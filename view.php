...
/// Check to see if groups are being used here
    ...
    if ($data->intro and empty($page) and empty($record) and $mode != 'single') {
        ...
        $texto  = '<br />';
        $texto .= '<b>Publicaciones hasta:</b> '.userdate($data->timeavailableto);
        $texto .= '<br />';
        $texto .= '<b>Publicaciones requeridas:</b> '.$data->requiredentries;
        $texto .= '<br />';
        $texto .= '<b>Comentarios hasta:</b> '.userdate($data->timecoment);
        $texto .= '<br />';
        $texto .= '<b>Comentarios requeridos:</b> '.$data->requiredcoment;
        $texto .= '<br />';
        $texto .= '<b>Calificaciones hasta:</b> '.userdate($data->timerating);
        $texto .= '<br />';
        $texto .= '<b>Calificaciones requeridas:</b> '.$data->requiredrating;
        $texto .= '<br />';
        print_box(format_text($data->intro.$texto, FORMAT_MOODLE, $options), 'generalbox', 'intro');
    }
