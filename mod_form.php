...
//-------------------------------------------------------------------------------
        ...
        $mform->addElement('date_selector', 'timecoment', get_string('timecoment', 'data'), array('optional'=>true));
        
        $mform->addElement('date_selector', 'timerating', get_string('timerating', 'data'), array('optional'=>true));
        ...
        $mform->addElement('select', 'requiredcoment', "Comentarios requeridos", $countoptions);
        ...
        $mform->addElement('select', 'requiredrating', "Calificaciones requeridas", $countoptions);
